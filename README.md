# Bư Bư English – 2000 Single Words
...
- 2000 từ đơn: 500 từ lõi có nghĩa tiếng Việt chi tiết và 1500 từ đơn mở rộng có sẵn trong dữ liệu tĩnh.
...
- Có 2 chế độ học: **Ngẫu nhiên** lấy lộn xộn từ toàn bộ kho và **Theo chủ đề** chỉ lấy từ trong đúng chủ đề đã chọn.
...
App hiện giữ đúng 2000 từ đơn. Từ mới phải được thêm sẵn vào dữ liệu; app không tự chế biến thể từ như `appleful` hoặc cụm như `my meat`. Phần câu ví dụ/cách dùng có thể dùng câu ngắn, nhưng kho từ và bài học hằng ngày chỉ chọn từ đơn.
...
src/
  ...
  data/         2000 từ đơn, prefix, suffix, collocation
