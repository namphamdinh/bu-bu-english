  ...
  return (
    <main className="home">
      <header className="hero">
        <div><span className="eyebrow">500 FIRST WORDS</span><h1>Bư Bư English</h1>
      ...
      <nav className="home-actions">
        ...
        <Link className="home-action" to="/vocabulary"><span>📚</span><div><strong>Kho 500 từ</strong><small>Tìm từ theo chủ đề</small></div></Link>
